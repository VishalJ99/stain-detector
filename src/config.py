...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Stain Detection Training and Inference')
    parser.add_argument('--config', type=str, default='configs/train_config.yaml', 
                        help='Path to configuration YAML file')
    parser.add_argument('--run_name', type=str, help='Override run name in config')
    ...
    parser.add_argument('--data_dir', type=str, help='Override data directory in config')
